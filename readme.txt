                                              GULP-START / 03.01.2025


ПРО ЗБІРКУ
--------------------------------------------------
Автор: Андрій Овчаров;
Дата збірки: 03.01.2025;
...
Запустити gulp: gulp
Якщо gulp не встановлено, то використайте команду: npm install --global gulp-cli
...
Всі вихідні зображення потрібно зберігати у теці app/images/src. Всі зображення конвертуються у формат: .webp.
...
@use 'vars';  // Вказуються змінні

@use 'fonts'; // Вказуються шрифти
...
Наприклад для header.html : @@include('header.html').
Наприклад для footer.html : @@include('footer.html').

Наприклад файл index.html

@@include('header.html')
<main class="main">
	<h1>Привіт, друже!</h1>
	<p>Майбутнє на кінчиках твоїх пальців. Пиши код!</p>
</main>
@@include('footer.html')
